...
--
-- Host: 127.0.0.1    Database: zooapp
-- ------------------------------------------------------
...
CREATE TABLE `alimentos` (
  ...
  `pesoLote` float(10,2) NOT NULL,
  `dataValidade` varchar(10) NOT NULL,
  `codfornecedor` int(5) NOT NULL,
  PRIMARY KEY (`codigo`),
  KEY `codfornecedor` (`codfornecedor`),
  CONSTRAINT `alimentos_ibfk_1` FOREIGN KEY (`codfornecedor`) REFERENCES `fornecedores` (`codigo`)
...
-- Dump completed on 2024-05-14 16:06:16
